...
export const SPECIALTY_STORES: readonly StoreInfo[] = [
  {
    ...
    type: "specialty",
    marketShare: 0.1,
    cuisines: ["chinese", "japanese", "korean", "southeast-asian"],
    aliases: [
      "wing yip",
      "wing yip superstore",
      "wing yip oriental",
  ...
  },
  {
    ...
    type: "specialty",
    marketShare: 0.1,
    cuisines: ["west-african", "east-african", "southern-african", "north-african", "caribbean"],
    aliases: [
      "african grocery",
      "african food store",
      "african store",
  ...
  },
  {
    ...
    type: "specialty",
    marketShare: 0.1,
    cuisines: ["middle-eastern", "turkish", "north-african"],
    aliases: [
