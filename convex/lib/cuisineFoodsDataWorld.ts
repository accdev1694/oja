...
export const CHINESE: CuisineSeedItem[] = [
  ...
  { name: "Sesame Oil", category: "Oils & Vinegars", estimatedPrice: 2.50, defaultSize: "250", defaultUnit: "ml" },
  { name: "Rice Vinegar", category: "Oils & Vinegars", estimatedPrice: 1.50, defaultSize: "250", defaultUnit: "ml" },
  ...
  { name: "Jasmine Rice", category: "Grains & Pasta", estimatedPrice: 3.00, defaultSize: "1", defaultUnit: "kg" },
  { name: "Egg Noodles", category: "Grains & Pasta", estimatedPrice: 1.50, defaultSize: "300", defaultUnit: "g" },
  { name: "Rice Noodles", category: "Grains & Pasta", estimatedPrice: 1.50, defaultSize: "250", defaultUnit: "g" },
  { name: "Firm Tofu", category: "Ethnic Ingredients", estimatedPrice: 1.80, defaultSize: "400", defaultUnit: "g" },
  ...
  { name: "Cornflour", category: "Baking", estimatedPrice: 0.80, defaultSize: "250", defaultUnit: "g" },
];

export const JAPANESE: CuisineSeedItem[] = [
  { name: "Sushi Rice", category: "Grains & Pasta", estimatedPrice: 3.50, defaultSize: "1", defaultUnit: "kg" },
  ...
  { name: "Nori Seaweed Sheets", category: "Ethnic Ingredients", estimatedPrice: 2.50, defaultSize: "10", defaultUnit: "pack" },
  { name: "Dashi Stock Powder", category: "Spices & Seasonings", estimatedPrice: 2.00, defaultSize: "50", defaultUnit: "g" },
  { name: "Panko Breadcrumbs", category: "Baking", estimatedPrice: 1.80, defaultSize: "200", defaultUnit: "g" },
  { name: "Udon Noodles", category: "Grains & Pasta", estimatedPrice: 2.00, defaultSize: "300", defaultUnit: "g" },
  { name: "Ramen Noodles", category: "Grains & Pasta", estimatedPrice: 1.50, defaultSize: "300", defaultUnit: "g" },
  ...
  { name: "Japanese Curry Roux", category: "Ethnic Ingredients", estimatedPrice: 2.50, defaultSize: "200", defaultUnit: "g" },
];
...
export const KOREAN: CuisineSeedItem[] = [
  ...
  { name: "Kimchi", category: "Ethnic Ingredients", estimatedPrice: 3.00, defaultSize: "400", defaultUnit: "g" },
  { name: "Korean Short Grain Rice", category: "Grains & Pasta", estimatedPrice: 4.00, defaultSize: "1", defaultUnit: "kg" },
  { name: "Korean Glass Noodles (Japchae)", category: "Grains & Pasta", estimatedPrice: 2.50, defaultSize: "300", defaultUnit: "g" },
  { name: "Sesame Seeds", category: "Spices & Seasonings", estimatedPrice: 1.50, defaultSize: "100", defaultUnit: "g" },
  { name: "Rice Cakes (Tteok)", category: "Ethnic Ingredients", estimatedPrice: 3.00, defaultSize: "500", defaultUnit: "g" },
  { name: "Korean Ramen Noodles", category: "Grains & Pasta", estimatedPrice: 1.50, defaultSize: "5", defaultUnit: "pack" },
];
...
export const SOUTHEAST_ASIAN: CuisineSeedItem[] = [
  ...
  { name: "Thai Jasmine Rice", category: "Grains & Pasta", estimatedPrice: 3.00, defaultSize: "1", defaultUnit: "kg" },
  { name: "Rice Noodles (Pad Thai)", category: "Grains & Pasta", estimatedPrice: 1.50, defaultSize: "250", defaultUnit: "g" },
...
export const MIDDLE_EASTERN: CuisineSeedItem[] = [
  { name: "Hummus", category: "Condiments & Sauces", estimatedPrice: 1.50, defaultSize: "300", defaultUnit: "g" },
  { name: "Tahini", category: "Condiments & Sauces", estimatedPrice: 2.50, defaultSize: "300", defaultUnit: "g" },
  { name: "Pitta Bread", category: "Bakery", estimatedPrice: 0.80, defaultSize: "6", defaultUnit: "pack" },
  ...
  { name: "Bulgur Wheat", category: "Grains & Pasta", estimatedPrice: 1.50, defaultSize: "500", defaultUnit: "g" },
  ...
  { name: "Lamb Mince", category: "Meat & Fish", estimatedPrice: 4.50, defaultSize: "500", defaultUnit: "g" },
];
...
export const TURKISH: CuisineSeedItem[] = [
  ...
  { name: "Bulgur Wheat (Fine)", category: "Grains & Pasta", estimatedPrice: 1.50, defaultSize: "500", defaultUnit: "g" },
  { name: "Sucuk (Turkish Sausage)", category: "Meat & Fish", estimatedPrice: 4.00, defaultSize: "250", defaultUnit: "g" },
  { name: "Dried Red Lentils", category: "Grains & Pasta", estimatedPrice: 1.50, defaultSize: "500", defaultUnit: "g" },
  { name: "Pul Biber (Chilli Flakes)", category: "Spices & Seasonings", estimatedPrice: 2.00, defaultSize: "100", defaultUnit: "g" },
  { name: "Turkish Bread (Pide)", category: "Bakery", estimatedPrice: 2.00, defaultSize: "1", defaultUnit: "pack" },
...
export const MEDITERRANEAN: CuisineSeedItem[] = [
  { name: "Extra Virgin Olive Oil", category: "Oils & Vinegars", estimatedPrice: 5.00, defaultSize: "500", defaultUnit: "ml" },
  { name: "Balsamic Vinegar", category: "Oils & Vinegars", estimatedPrice: 2.50, defaultSize: "250", defaultUnit: "ml" },
  { name: "Passata", category: "Canned & Jarred", estimatedPrice: 0.80, defaultSize: "500", defaultUnit: "g" },
  { name: "Spaghetti", category: "Grains & Pasta", estimatedPrice: 0.70, defaultSize: "500", defaultUnit: "g" },
  { name: "Risotto Rice (Arborio)", category: "Grains & Pasta", estimatedPrice: 2.00, defaultSize: "500", defaultUnit: "g" },
  ...
  { name: "Olives (Mixed)", category: "Canned & Jarred", estimatedPrice: 2.00, defaultSize: "280", defaultUnit: "g" },
  ...
  { name: "Ciabatta Bread", category: "Bakery", estimatedPrice: 1.50, defaultSize: "1", defaultUnit: "pack" },
  { name: "Prosciutto", category: "Meat & Fish", estimatedPrice: 3.00, defaultSize: "70", defaultUnit: "g" },
];
...
export const FRENCH: CuisineSeedItem[] = [
  ...
  { name: "Baguette", category: "Bakery", estimatedPrice: 1.00, defaultSize: "1", defaultUnit: "pack" },
  { name: "Croissants", category: "Bakery", estimatedPrice: 1.50, defaultSize: "4", defaultUnit: "pack" },
  { name: "Lentils (Puy)", category: "Grains & Pasta", estimatedPrice: 2.00, defaultSize: "500", defaultUnit: "g" },
...
export const EASTERN_EUROPEAN: CuisineSeedItem[] = [
  ...
  { name: "Kielbasa Sausage", category: "Meat & Fish", estimatedPrice: 3.50, defaultSize: "400", defaultUnit: "g" },
  { name: "Sauerkraut", category: "Canned & Jarred", estimatedPrice: 1.50, defaultSize: "680", defaultUnit: "g" },
  { name: "Beetroot (Cooked)", category: "Canned & Jarred", estimatedPrice: 0.80, defaultSize: "300", defaultUnit: "g" },
  { name: "Buckwheat", category: "Grains & Pasta", estimatedPrice: 2.00, defaultSize: "500", defaultUnit: "g" },
  { name: "Rye Bread", category: "Bakery", estimatedPrice: 2.00, defaultSize: "500", defaultUnit: "g" },
  ...
  { name: "Pickled Cucumbers", category: "Canned & Jarred", estimatedPrice: 1.50, defaultSize: "670", defaultUnit: "g" },
];

export const LATIN_AMERICAN: CuisineSeedItem[] = [
  { name: "Corn Tortillas", category: "Bakery", estimatedPrice: 1.50, defaultSize: "8", defaultUnit: "pack" },
  { name: "Flour Tortillas", category: "Bakery", estimatedPrice: 1.50, defaultSize: "8", defaultUnit: "pack" },
  { name: "Black Beans (Tinned)", category: "Canned & Jarred", estimatedPrice: 0.70, defaultSize: "400", defaultUnit: "g" },
  { name: "Refried Beans", category: "Canned & Jarred", estimatedPrice: 1.00, defaultSize: "400", defaultUnit: "g" },
  ...
  { name: "Sweetcorn (Tinned)", category: "Canned & Jarred", estimatedPrice: 0.60, defaultSize: "340", defaultUnit: "g" },
  { name: "Masa Harina", category: "Ethnic Ingredients", estimatedPrice: 3.00, defaultSize: "1", defaultUnit: "kg" },
